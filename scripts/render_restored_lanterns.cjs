...
const outPath = 'C:/Users/USER/.gemini/antigravity-ide/brain/7bb94944-7be5-403f-8dd9-f6197abeb2ec/scratch/restored_16_lanterns_top.png';

sharp(Buffer.from(svgContent))
  .extract({ left: 0, top: 0, width: 1920, height: 260 })
  .png()
  .toFile(outPath)
  .then(() => {
