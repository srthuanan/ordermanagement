...
const LoginScreen: React.FC<LoginScreenProps> = ({ onLoginSuccess, showToast }) => {
    ...
    return (
        <div className="halloween halloween-bg relative h-screen w-screen overflow-hidden flex items-center justify-center p-4">
            ...
            <div className="relative z-20 w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 lg:gap-8 items-center">
                ...
                <div className="hidden lg:col-span-2 lg:flex flex-col items-center justify-center text-center p-8">
                    <img
                        src={backgroundGif}
                        alt="Background Animation"
                        className="w-full max-w-lg animate-ghostly-fade"
                    />
                    <h2 className="text-4xl xl:text-5xl font-extrabold tracking-tight text-shadow leading-tight mt-6 animate-spooky-flicker">
                        Hệ Thống Quản Lý<br/>Đơn Hàng Nội Bộ
                    </h2>
                </div>
                
                {/* --- Right Form Panel --- */}
                <div className="form-panel-hallo w-full max-w-sm mx-auto lg:max-w-none lg:mx-0 rounded-2xl flex flex-col justify-center p-8 sm:p-10">
                    {viewMode === 'login' && (
                        <div className="w-full animate-fade-in-up">
                            ...
                            <form onSubmit={handleLoginSubmit} className="space-y-6">
                                ...
                                <button type="submit" disabled={isSubmitting} className="halloween-gate-button w-full mt-2">
                                    {isSubmitting ? (
                                        <>
                    ...
                    {viewMode === 'forgot' && (
                        <div className="w-full animate-fade-in-up">
                            ...
                            <form onSubmit={handleForgotPasswordSubmit} className="space-y-6">
                                ...
                                <button type="submit" disabled={isSubmitting} className="halloween-gate-button w-full mt-4">{isSubmitting ? <><i className="fas fa-spinner animate-spin mr-2"></i>Đang gửi...</> : 'Gửi Mã OTP'}</button>
                     ...
                     {viewMode === 'reset' && (
                        <div className="w-full animate-fade-in-up">
                            ...
                            <form onSubmit={handleResetPasswordSubmit} className="space-y-6">
                                ...
                                <button type="submit" disabled={isSubmitting} className="halloween-gate-button w-full mt-4">{isSubmitting ? <><i className="fas fa-spinner animate-spin mr-2"></i>Đang xử lý...</> : 'Xác Nhận'}</button>
