...
const TimelineItem: React.FC<{ item: TimelineItemData }> = ({ item }) => (
    <div className="relative pl-8 py-4 group">
        <div className="absolute top-4 left-0 w-4 h-4 rounded-full bg-accent-primary/20 border-4 border-surface-card group-hover:bg-accent-primary transition-colors"></div>
        <div className="pl-4">
            <p className="font-bold text-text-primary">{item['Hành động']}</p>
            <p className="text-sm text-text-secondary mt-1">{item['Chi tiết']}</p>
            <div className="text-xs text-text-secondary mt-2 flex items-center gap-4">
        ...
        <div className="absolute top-6 left-[7px] h-full border-l-2 border-dashed border-border-primary group-last:border-none"></div>
    </div>
);
                ...
                <main className="p-6 space-y-4 overflow-y-auto">
                    <div className="flex items-center gap-3">
                        <input
                            ...
                            className="flex-grow bg-surface-ground border border-border-primary rounded-lg p-2.5 focus:ring-accent-primary focus:border-accent-primary transition futuristic-input"
                        />
