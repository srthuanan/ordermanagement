...
export const allPossibleVersions = [
    "Tiêu chuẩn", "Base", "Plus", "Plus Tiêu chuẩn", "Plus Nâng cấp", "Eco", "Eco_HUD", "Eco Tiêu chuẩn", "Eco Nâng cấp",
...
export const defaultExteriors = [
    ...
    "Silver (CE17)", "Desat Silver (CE17)", "Pink Gold (CE2K)", "Solar Ruby (CE2Q)", "Moonlit Ocean (CE2J)",
    "Infinity Blanc Roof-Sky Blue (182G)", "Introspective Brown (CE2N)",
    "Rose Pink (CE21)", "Sky Blue (CE2G)", "Pebble Beige (CE2T)",
    "Starburst Blue (CE33)", 
...
export const interiorColorRules = [
    { models: ["vf 2", "vf2"], colors: ["Grey", "Black"] },
...
export const VALID_IMAGES_BY_MODEL: Record<string, string[]> = {
    "vf2": ["ce18", "ce17", "ce2q", "ce1w", "ce1u", "ce21", "ce2g", "ce2t"],
